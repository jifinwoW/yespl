...
$MODULENAME = 'SparePartsReplacement';
$moduleLabel = 'Spare Part Replacement';
...
$block1->label = 'LBL_SPR_DETAILS';
$moduleInstance->addBlock($block1);

$fields = [
    [
        'name' => 'spr_name',
        'label' => 'Spare Parts Replacement Name',
        'uitype' => 1,
...
$relFields = [
    ['name' => 'spr_product_id', 'label' => 'Spare Part', 'relatedto' => 'Products'],
    ['name' => 'spr_engineer_id', 'label' => 'Engineer', 'relatedto' => 'Engineer'],
     ['name' => 'spr_ticket_id', 'label' => 'Ticket', 'relatedto' => 'Tickets']
];
...
$childModule = Vtiger_Module::getInstance('SparePartsReplacement');
$parentModule->setRelatedList($childModule, 'Spare Part Replacement List', ['ADD', 'SELECT'], 'get_dependents_list');

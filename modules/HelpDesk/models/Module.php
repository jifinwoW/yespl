...
class HelpDesk_Module_Model extends Vtiger_Module_Model {
	...
	/**
	 * Declare which fields in HelpDesk provide values for auto-filling related modules.
	 * Used by RelationListView when building the create-record URL for dependent modules.
	 */

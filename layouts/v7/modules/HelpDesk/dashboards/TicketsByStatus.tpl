...
{if php7_count($DATA) gt 0}
	{assign var=WIDGET_UNIQ value=$WIDGET->get('id')|default:$WIDGET->get('linkid')|default:101}
	...
	<div style="padding:10px; width:100%; position:relative; height:200px;">
		<canvas id="chartjs_tickets_{$WIDGET_UNIQ}" data-chart="{$CHART_DATA}" style="width:100%; height:180px;"></canvas>
	</div>
	<script type="text/javascript">
	(function() {
		var targetId = 'chartjs_tickets_{$WIDGET_UNIQ}';
		{literal}

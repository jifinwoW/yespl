/* Chart.js - Leads by Source Pie Widget */
(function () {
    var container = document.querySelector('.vtChartLeadsBySource:not([data-chartjs-init])');
    if (!container) return;
    ...
    var chart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                legend: {
                    position: 'bottom',
                    labels: { padding: 12, font: { size: 12 }, usePointStyle: true, pointStyleWidth: 10 }
                },
                tooltip: {
                    callbacks: {
                        label: function (c) {
